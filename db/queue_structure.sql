CREATE TABLE IF NOT EXISTS "solid_queue_blocked_executions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "job_id" bigint NOT NULL, "queue_name" varchar NOT NULL, "priority" integer DEFAULT 0 NOT NULL, "concurrency_key" varchar NOT NULL, "expires_at" datetime NOT NULL, "created_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "solid_queue_claimed_executions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "job_id" bigint NOT NULL, "process_id" bigint, "created_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "solid_queue_pauses" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "queue_name" varchar NOT NULL, "created_at" datetime NOT NULL);
CREATE UNIQUE INDEX "index_solid_queue_pauses_on_queue_name" ON "solid_queue_pauses" ("queue_name");
CREATE TABLE IF NOT EXISTS "solid_queue_processes" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "kind" varchar NOT NULL, "last_heartbeat_at" datetime NOT NULL, "supervisor_id" bigint, "pid" integer NOT NULL, "hostname" varchar, "metadata" text, "created_at" datetime NOT NULL, "name" varchar NOT NULL);
...
CREATE TABLE IF NOT EXISTS "solid_queue_ready_executions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "job_id" bigint NOT NULL, "queue_name" varchar NOT NULL, "priority" integer DEFAULT 0 NOT NULL, "created_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "solid_queue_recurring_executions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "job_id" bigint NOT NULL, "task_key" varchar NOT NULL, "run_at" datetime NOT NULL, "created_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "solid_queue_recurring_tasks" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "key" varchar NOT NULL, "schedule" varchar NOT NULL, "command" varchar(2048), "class_name" varchar, "arguments" text, "queue_name" varchar, "priority" integer DEFAULT 0, "static" boolean DEFAULT 1 NOT NULL, "description" text, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "solid_queue_scheduled_executions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "job_id" bigint NOT NULL, "queue_name" varchar NOT NULL, "priority" integer DEFAULT 0 NOT NULL, "scheduled_at" datetime NOT NULL, "created_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "solid_queue_semaphores" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "key" varchar NOT NULL, "value" integer DEFAULT 1 NOT NULL, "expires_at" datetime NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
